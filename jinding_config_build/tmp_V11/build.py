...
class Build(Relation):
    ...
    def init_staff(self, state):
        self.tk = Tk()
        self.init_buttons(self.tk, 0, 0, self.sce, self.callback, state)
        self.init_buttons(self.tk, 1, 0, self.indep, self.callback, state)
        self.init_buttons(self.tk, 2, 0, self.chief, self.callback, state)
        self.init_buttons(self.tk, 3, 0, self.depends, self.callback, state)
